...
func (e PetEdges) UserOrErr() (*User, error) {
	if e.loadedTypes[0] {
		if e.User == nil {
...
func (*Pet) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case pet.FieldName, pet.FieldDesc:
...
// QueryUser queries the "user" edge of the Pet entity.
func (pe *Pet) QueryUser() *UserQuery {
	return (&PetClient{config: pe.config}).QueryUser(pe)
}
...
func (pe *Pet) Unwrap() *Pet {
	...
	if !ok {
		panic("entgen: Pet is not a transactional entity")
	}
