...
func (pu *PetUpdate) SetDesc(s string) *PetUpdate {
	pu.mutation.SetDesc(s)
	return pu
}

// SetUserID sets the "user" edge to the User entity by ID.
func (pu *PetUpdate) SetUserID(id int) *PetUpdate {
	pu.mutation.SetUserID(id)
	return pu
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (pu *PetUpdate) SetNillableUserID(id *int) *PetUpdate {
	if id != nil {
		pu = pu.SetUserID(*id)
	}
	return pu
...
// SetDesc sets the "desc" field.
func (puo *PetUpdateOne) SetDesc(s string) *PetUpdateOne {
	puo.mutation.SetDesc(s)
	return puo
}

// SetUserID sets the "user" edge to the User entity by ID.
func (puo *PetUpdateOne) SetUserID(id int) *PetUpdateOne {
	puo.mutation.SetUserID(id)
	return puo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (puo *PetUpdateOne) SetNillableUserID(id *int) *PetUpdateOne {
	if id != nil {
...
func (puo *PetUpdateOne) sqlSave(ctx context.Context) (_node *Pet, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`entgen: missing "Pet.id" for update`)}
	}
