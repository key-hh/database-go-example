...
type PetFunc func(context.Context, *entgen.PetMutation) (entgen.Value, error)

// Mutate calls f(ctx, m).
func (f PetFunc) Mutate(ctx context.Context, m entgen.Mutation) (entgen.Value, error) {
	mv, ok := m.(*entgen.PetMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *entgen.PetMutation", m)
	}
	return f(ctx, mv)
}
