...
func (pc *PetCreate) SetDesc(s string) *PetCreate {
	pc.mutation.SetDesc(s)
	return pc
}

// SetUserID sets the "user" edge to the User entity by ID.
func (pc *PetCreate) SetUserID(id int) *PetCreate {
	pc.mutation.SetUserID(id)
	return pc
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (pc *PetCreate) SetNillableUserID(id *int) *PetCreate {
	if id != nil {
		pc = pc.SetUserID(*id)
	}
	return pc
...
func (pc *PetCreate) SetUser(u *User) *PetCreate {
...
func (pc *PetCreate) check() error {
	if _, ok := pc.mutation.Name(); !ok {
		return &ValidationError{Name: "name", err: errors.New(`entgen: missing required field "Pet.name"`)}
	}
	if _, ok := pc.mutation.Desc(); !ok {
		return &ValidationError{Name: "desc", err: errors.New(`entgen: missing required field "Pet.desc"`)}
	}
	return nil
}
